...
1. Push this repo to GitHub / GitLab / Cursor Origin
2. Import the project in [Vercel](https://vercel.com/new)
3. Add environment variables from `.env.example`
4. Create a **Blob** store in the Vercel project so engagements persist across serverless runs (`BLOB_READ_WRITE_TOKEN` is injected, or add it yourself)
5. Deploy. Share the URL and the access code with the team, not with the public internet.
...
2. Ranked 5–7 company table with disclosure-maturity and likely blind spots
...
7. You choose 2–4 issues, model types (cost / revenue / capex / WACC / hybrid), and build mode
